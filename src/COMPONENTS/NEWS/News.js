        ...
        <>
            <div className='news-container' id='news'>
                <div className="news">
                    ...
                    <p ref={addToRefs} className='new slide-in'>Dňa 12.05. 2025 od 10:00 - 16:00 hod. bude v Dermocentre Vitalis prebiehať PROMO AKCIA na kozmetiku Avène, A-Derma, Ducray a Klorane,
