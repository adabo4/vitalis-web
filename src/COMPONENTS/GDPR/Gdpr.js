                ...
                <div id='gdpr'>
                    ...
                    <div className="gdpr-points">
                        <ol>
                            ...
                            <p>Osobné údaje získané prostredníctvom webovej stránky sú spracúvané obchodnou spoločnosťou <strong> LEKAMED, s.r.o.,
                                so sídlom Trhová 4, 91701 Trnava, IČO: 36737607, zapísaná v Obchodnom registri Okresného súdu Bratislava I,
                                oddiel: Sro, vložka č.: 134897/B, </strong> ktorá má pri spracúvaní osobných údajov postavenie prevádzkovateľa
                            ...
                            <p>Osobné údaje dotknutej osoby, ktoré prevádzkovateľ získava prostredníctvom webovej stránky, sú poskytované nasledovným príjemcom:</p>
                            <ul>
                                <li>
                                    <strong>EMAILJS PTE. LTD.,</strong> 139 CECIL STREE, #03-10 YSY BUILDING, SINGAPORE (069539), <strong>ako poskytovateľovi služieb aplikácie EmailJS (www.emailjs.com), ktoré môžu byť zo strany prevádzkovateľa využívané pri uskutočňovaní činnosti súvisiacej s odoslaním kontaktného formulára dotknutou osobou.</strong>
                                </li>
                            </ul>
                            ...
                            <p>Prevádzkovateľ využíva softvérové riešenie poskytovateľa služieb na e-mailovanie, konkrétne www.emailjs.com, na účely spracovania osobných údajov získaných prostredníctvom kontaktného formulára na webovej stránke. Poskytnuté osobné údaje, ako sú meno a e-mailová adresa, budú spracovávané za účelom zabezpečenia doručenia správnej odpovede alebo informácií na uvedený e-mailový kontakt lekarenvitalis@gmail.com.
                            ...
                            <p>Dotknutá osoba má v súvislosti so spracúvaním svojich osobných údajov nasledovné práva, ktorých uplatnenie môže realizovať zaslaním žiadosti na e-mailovú adresu prevádzkovateľa alebo adresu sídla jeho spoločnosti, ktoré sú uvedené v týchto Podmienkach spracúvania osobných údajov, a to za podmienok vymedzených v GDPR:</p>
                            <ul>
                                <li><strong>Právo na prístup k vlastným osobným údajom podľa článku 15 GDPR</strong></li>
                                <li><strong>Právo na opravu osobných údajov podľa článku 16 GDPR (alebo obmedzenie spracovania podľa článku 18 GDPR).
                                </strong></li>
                            ...
                            <p>
                                Subjekt údajov má ďalej právo podať sťažnosť Úradu pre ochranu osobných údajov v prípade, že má podozrenie, že bolo porušené jeho právo na ochranu údajov.
                            </p>
                            <li>
                                <h3>Poskytovanie osobných údajov</h3>
                            </li>
                            <p>Prevádzkovateľ informuje dotknutú osobu, že poskytovanie jej osobných údajov, ku ktorých získavaniu dochádza prostredníctvom webovej stránky, nie je zákonnou ani zmluvnou požiadavkou. Neposkytnutie osobných údajov nemá pre dotknutú osobu žiadne negatívne následky. Neposkytnutie osobných údajov môže mať za následok obmedzenie využívania niektorých doplnkových služieb prevádzkovateľa.</p>
                            <li>
                                <h3>KONTAKTNÝ FORMULÁR a spracúvanie osobných údajov</h3>
                                <ul>
                                    <li>Účel spracúvania osobných údajov
                                        <p>V prípade, ak dochádza k získavaniu osobných údajov dotknutej osoby prostredníctvom kontaktného formulára umiestneného na webovej stránke, osobné údaje v rozsahu meno, e-mail, prípadne v rozsahu osobných údajov zadaných do textu správy doručovanej prostredníctvom kontaktného formulára sú spracúvané na účely kontaktovania prevádzkovateľa a zabezpečenia vzájomnej komunikácie medzi dotknutou osobou a prevádzkovateľom v súvislosti s akýmikoľvek produktmi a službami prevádzkovateľa a/alebo v súvislosti s vybavovaním podnetov a poskytovaním potrebných informácií dotknutej osobe.
                                        </p>
                                    </li>
                                    <li>Právny základ spracúvania
                                        <p>Osobné údaje návštevníka webovej stránky, ktorého osobného údaje boli získané prostredníctvom kontaktného formulára sú spracúvané na základe oprávneného záujmu prevádzkovateľa (čl. 6 ods. 1 písm. f) GDPR). Prevádzkovateľ pred vykonávaním spracúvania osobných údajov na tomto právnom základe dôsledne preskúmal, či výkon takejto spracovateľskej operácie nepredstavuje neprimeraný zásah do práv a slobôd dotknutej osoby, a za týmto účelom uskutočnil test proporcionality.</p>
                                        <p>Oprávnený záujem prevádzkovateľa je daný snahou prevádzkovateľa zaistiť vybavovanie podnetov dotknutej osoby a/alebo poskytovanie iných informácií o prevádzkovateľom poskytovaných službách.</p>
                                    </li>
                                    <li>Doba uchovávania osobných údajov
                                        <p>Osobné údaje dotknutej osoby získané prostredníctvom kontaktného formulára sú spracúvané po dobu 1 roka odo dňa získania osobných údajov dotknutej osoby.</p>
                                    </li>
                                </ul>
                            </li>
                            <li><h3>Podmienky zabezpečenia osobných údajov</h3></li>
                            <p>Prevádzkovateľ vyhlasuje, že prijal všetky vhodné technické a organizačné opatrenia na zabezpečenie osobných údajov.
                                Prevádzkovateľ vyhlasuje, že k osobným údajom majú prístup iba osoby, ktoré sú ním poverené.
                            </p>
                            <li><h3>Záverečné ustanovenia.</h3></li>
                            <p>S týmito podmienkami súhlasíte zaškrtnutím súhlasu prostredníctvom internetového formulára. Zaškrtnutím súhlasu potvrdzujete, že ste sa oboznámil(a) s podmienkami ochrany osobných údajov a že ich plne akceptujete.
                                Prevádzkovateľ má právo tieto podmienky zmeniť. Novú verziu podmienok ochrany osobných údajov zverejní na svojej internetovej stránke.
                            </p>
